...
angular.module('dockerui.templates', ['app/components/builder/builder.html', 'app/components/container/container.html', 'app/components/containerLogs/containerlogs.html', 'app/components/containerTop/containerTop.html', 'app/components/containers/containers.html', 'app/components/containersNetwork/containersNetwork.html', 'app/components/dashboard/dashboard.html', 'app/components/dialogs/scaleDialog.html', 'app/components/events/events.html', 'app/components/footer/statusbar.html', 'app/components/hosts/hosts.html', 'app/components/image/image.html', 'app/components/images/images.html', 'app/components/info/info.html', 'app/components/masthead/masthead.html', 'app/components/service/service.html', 'app/components/services/services.html', 'app/components/sidebar/sidebar.html', 'app/components/startContainer/startcontainer.html']);
...
angular.module("app/components/containers/containers.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/components/containers/containers.html",
    ...
    "            <td><a href=\"#/containers/{{ container.Id }}/\">{{ container|shortcontainername}}</a></td>\n" +
...
angular.module("app/components/dialogs/scaleDialog.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/components/dialogs/scaleDialog.html",
    "<div id=\"scale-modal\" class=\"modal fade\">\n" +
    "    <div class=\"modal-dialog\">\n" +
    "        <div class=\"modal-content\">\n" +
    "            <div class=\"modal-header\">\n" +
    "                <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">&times;</button>\n" +
    ...
    "                    <tbody>\n" +
    "                        <tr>\n" +
    "                            <td class=\"col-md-4\">Scale type</td>\n" +
    "                            <td>\n" +
    "                                <select ng-model=\"scaleConfig.type\" class=\"form-control\">\n" +
    ...
    "                        </tr>\n" +
    "                        <tr>\n" +
    "                            <td class=\"col-md-4\">Container number</td>\n" +
    "                            <td><input type=\"text\" ng-model=\"scaleConfig.number\" class=\"form-control\"></input></td>\n" +
    "                        </tr>\n" +
    "                        </tbody>\n" +
    "                </table>\n" +
    "            </div>\n" +
    "            <div class=\"modal-footer\">\n" +
    "                <button class=\"btn btn-primary\" ng-click=\"scale()\">Scale</button>\n" +
...
angular.module("app/components/footer/statusbar.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/components/footer/statusbar.html",
    ...
    "    <p><small>Docker API Version: <strong>{{ apiVersion }}</strong> UI Version: <strong>{{ uiVersion }}</strong> <a class=\"pull-right\" href=\"https://github.com/wansc2015/dockerui\">dockerui</a></small></p>\n" +
    "</footer>\n" +
    "");
}]);
...
angular.module("app/components/hosts/hosts.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/components/hosts/hosts.html",
    ...
    "            <td title=\"{{host.ID}}\">{{ host.Name}}</td>\n" +
    "			<td>{{ host.OperatingSystem }}</td>\n" +
    "            <td>{{ host.Containers }}</td>\n" +
    "            <td>{{ host.IP}}</td>\n" +
    "            <td>{{ host.NCPU }}</td>\n" +
    "            <td>{{ host.MemTotal|memory}}</td>\n" +
    "        </tr>\n" +
    "    </tbody>\n" +
    "</table>\n" +
    "");
...
angular.module("app/components/service/service.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/components/service/service.html",
    "<div ng-include=\"template\" ng-controller=\"ScaleDialogController\"></div>\n" +
    "\n" +
    "<div class=\"detail\">\n" +
    "    \n" +
    "    <div>\n" +
    "        <h4>Service: {{ service.name }}\n" +
    "            <!--<button class=\"btn btn-primary\"\n" +
    "                    ng-click=\"service.edit = true;\">Rename</button>-->\n" +
    "        </h4>\n" +
    "    </div>\n" +
    "    \n" +
    "    <div class=\"btn-group detail\">\n" +
    "      <button class=\"btn btn-success\"\n" +
    "            ng-click=\"start()\"\n" +
    "            ng-show=\"!service.CurrentState.Running\">Start</button>\n" +
    "      <button class=\"btn btn-warning\"\n" +
    "            ng-click=\"stop()\"\n" +
    "            ng-show=\"service.CurrentState.lauching\">Stop</button>\n" +
    "      <button class=\"btn btn-danger\"\n" +
    "            ng-click=\"kill()\"\n" +
    "            ng-show=\"service.State.Running && !service.State.Paused\">Kill</button>\n" +
    "      <button class=\"btn btn-info\"\n" +
    "            ng-click=\"pause()\"\n" +
    "            ng-show=\"service.State.Running && !service.State.Paused\">Pause</button>\n" +
    "      <button class=\"btn btn-success\"\n" +
    "            ng-click=\"unpause()\"\n" +
    "            ng-show=\"service.State.Running && service.State.Paused\">Unpause</button>\n" +
    "	  <button class=\"btn btn-info\"\n" +
    "            ng-click=\"scaleAction()\">Scale</button>\n" +
    "    </div>\n" +
    "\n" +
    "    <table class=\"table table-striped\">\n" +
    "         <tbody>\n" +
    ...
    "            <tr>\n" +
    "                <td>Current State:</td>\n" +
    "                <td><span class=\"label label-{{ service.CurrentState|statusbadge }}\">{{ service.CurrentState}}</span></td>\n" +
    "            </tr>\n" +
    "            <tr>\n" +
    "                <td>Desired State: </td>\n" +
    "                <td><span class=\"label label-{{ service.DesiredState|statusbadge }}\">{{ service.DesiredState}}</span></td>                \n" +
    "            </tr>\n" +
    "            <tr>\n" +
    "                <td>Environment:</td>\n" +
    "                <td>\n" +
    "                    <ul style=\"display:inline-table\">\n" +
    "                        <li ng-repeat=\"k in service.definition.environment\">{{ k }}</li>\n" +
    "                    </ul>\n" +
    "                </td>\n" +
    "            </tr>\n" +
    "			<tr>\n" +
    ...
    "				<td>\n" +
    "                    <ul style=\"display:inline-table\">\n" +
    "                        <li ng-repeat=\"port in service.definition.ports\">\n" +
    "                            {{ port }}\n" +
    "                        </li>\n" +
    "                    </ul>\n" +
    "                </td>\n" +
    ...
    "			<tr>\n" +
    "                <td>Volumes:</td>\n" +
    "                <td><ul style=\"display:inline-table\">\n" +
    "                        <li ng-repeat=\"k in service.definition.volumes\">{{ k }}</li>\n" +
    "                    </ul>\n" +
    "				</td>\n" +
    "            </tr>\n" +
    "			<tr>\n" +
    "                <td>Image:</td>\n" +
    "                <td><a href=\"#/images/{{ service.definition.image }}/\">{{ service.definition.image }}</a></td>\n" +
    "            </tr>\n" +
    "            <tr>\n" +
    "                 <td>Logs:</td>\n" +
    "                 <td>\n" +
    "                    <ul style=\"display:inline-table\">\n" +
    "                        <li ng-repeat=\"k in service.definition.logs\">{{ k }}</li>\n" +
    "                    </ul>\n" +
    "                </td>\n" +
    "            </tr>\n" +
    "			<tr>\n" +
    "                 <td>Container number:</td>\n" +
    "                 <td>{{ service.definition.scale }}</a></td>\n" +
    "            </tr>\n" +
    "			<tr>\n" +
    "                <td>Hostname:</td>\n" +
    "                <td>{{ service.definition.dns_entry.host_name }}</td>\n" +
    "            </tr>\n" +
    "			<tr>\n" +
    "                 <td>Endpoint:</td>\n" +
    "                 <td><ul style=\"display:inline-table\">\n" +
    "                        <li ng-repeat=\"k in service.definition.routing\">\n" +
    "                            {{k|endpoint}}\n" +
    "                        </li>\n" +
    "                    </ul>\n" +
    "				</td>\n" +
...
angular.module("app/components/services/services.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/components/services/services.html",
    "<h2>Services</h2>\n" +
    "<div>\n" +
    "    <ul class=\"nav nav-pills pull-left\">\n" +
    "        <li class=\"dropdown\">\n" +
